...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { attraction_category_id: @attraction.attraction_category_id, name: @attraction.name }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { attraction_category_id: @attraction.attraction_category_id, name: @attraction.name }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
