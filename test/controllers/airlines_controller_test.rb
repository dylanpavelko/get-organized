...
class AirlinesControllerTest < ActionController::TestCase
  ...
  test "should create airline" do
    assert_difference('Airline.count') do
      post :create, airline: { image: @airline.image, loyalty_program_id: @airline.loyalty_program_id, name: @airline.name }
    end
  ...
  test "should update airline" do
    patch :update, id: @airline, airline: { image: @airline.image, loyalty_program_id: @airline.loyalty_program_id, name: @airline.name }
    assert_redirected_to airline_path(assigns(:airline))
  end
